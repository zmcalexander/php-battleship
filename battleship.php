...
$jolly_rogers = array( 
    ...
    0 => array(display => "Aircraft Carrier", type => "aircraft_carrier", size => 5),
    1 => array(display => "Battleship", type => "battleship", size => 4),
    2 => array(display => "Submarine", type => "submarine", size => 3),
    3 => array(display => "Destroyer", type => "destroyer", size => 3),
    4 => array(display => "Cruiser", type => "cruiser", size => 2);
...
// bring in the variables
    global $carrierPosition, $battleshipPosition, $destroyerPosition, $submarinePosition, $cruiserPosition, $misses;
...
if(!empty($_GET['move'])) {
	...
	echo "Game over. You suck at this";
		session_unset(); 
...
function evaluateMove() {
    // bring in the variables
    global $carrierHits, $battleshipHits, $destroyerHits, $submarineHits, $cruiserHits, $missed, $ships_sunk;
/*if ($missed == true) {
